...
"""
Supabase Document Store for backend services.

This module provides a custom document store implementation that uses Supabase
(PostgreSQL with pgvector) for storage and retrieval.
"""
...
# Local definitions for Haystack 2 compatibility (these are not part of haystack-ai)
