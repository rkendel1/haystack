...
class ComponentTool(Tool):
    ...
    Below is an example of creating a ComponentTool from an existing SearXNGWebSearch component.
    ...
    # Create a SearXNG search component
    search = SearXNGWebSearch(base_url="http://localhost:8888", top_k=3)

    # Create a tool from the component
    tool = ComponentTool(
        component=search,
        name="web_search",  # Optional: defaults to "searxng_web_search"
